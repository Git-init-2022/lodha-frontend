          ...
          </Accordion.Item>
          {
            isAdmin ?
              <Accordion.Item eventKey="0">
                ...
                <Accordion.Body className='ExpandDropDown'>
                  {(JSON.parse(User).Role === '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918' || JSON.parse(User).Role === 'ab6db599234d2636659cba1aa191bd014c3867d5cfade98ff694785c20c28fc6') ? <a href='/Finance'>Finance & Account</a> : <></>}
                  {/* {(JSON.parse(User).Role === '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918' || JSON.parse(User).Role === '440f3041c89adee0f2ad780704bcc0efae1bdb30f8d77dc455a2f6c823b87ca0') ? <a href='/FM'>FM</a> : <></>} */}
                  ...
                  {JSON.parse(User).Role === '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918' ? <a href='/StaffManagement'> Staff Management</a> : <></>}
                </Accordion.Body>
              </Accordion.Item>
              : <></>
          }
