    ...
    <>
      ...
      <div className="KeyContactDiv">
        <div style={{ display: "flex", justifyContent: "center", }}>
          <img src={communication} style={{ height: "70px", width: "70px", marginTop: "5px", marginBottom: "30px" }}></img>
          <p id="userDashboardTitle" >KEY COMMUNICATIONS</p>
        </div>
...
export default KeyCommunications;
